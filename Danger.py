...
TOKEN = '7543528264:AAFk6lfBip14eeUA9kKEVTT59UdmD_Su14o'
MONGO_URI = 'mongodb+srv://Cluster0:Cluster0@cluster0.5mvg9ej.mongodb.net/danger?retryWrites=true&w=majority'
FORWARD_CHANNEL_ID =1002316460517
CHANNEL_ID =-1002316460517
error_channel_id =1002316460517
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @pk123kumar456.*", parse_mode='Markdown')  # Contact owner message
            return
...
def process_attack_command(message):
    try:
        ...
        if target_port in blocked_ports:
            ...
            return
        if duration >= 600:
            bot.send_message(message.chat.id, "*⏳ Maximum duration is 180 seconds.*\n"  # Duration limit message
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @pk123kumar456* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @pk123kumar456* 🙏"  # Contact owner message
    else:
